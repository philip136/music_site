# Generated by Django 2.2.4 on 2019-08-08 11:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ManyToManyField(blank=True, to='music.Album')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='music.SongsAlbum')),
